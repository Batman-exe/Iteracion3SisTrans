...
//			e.printStackTrace();
    ...
    public void adicionarPersonaNatural( )
    {
    	try 
    	{
    		String documento = JOptionPane.showInputDialog (this, "Numero de documento del cliente?", "Adicionar operador", JOptionPane.QUESTION_MESSAGE);
    		Long numDoc = Long.valueOf(documento);
